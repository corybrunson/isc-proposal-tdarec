...
Each package release will be announced on multiple social media platforms using the `#rstats` tag and on blogs cross-posted to R-bloggers.
We will submit abstracts for each aim to relevant conferences (including useR!, `posit::conf()`, the Joint Statistical Meetings).
We will also propose in-person workshops co-located with local or regional conferences.
