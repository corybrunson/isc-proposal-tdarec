...
The PIs will provide the R Consortium with monthly updates based on progress toward the deliverables below.
...
2. Template {recipes} extension, to ensure that checks unrelated to implementations are satisfied. (<= 2wk)
...
5. Vignette illustrating complete modeling workflow using at least two topological transformations. (<= 2wk)
...
2. Integration into package using {Rcpp}. (<= 3wk)
