...
Development will take place publicly on two GitHub accounts: TDAverse, co-owned by Dr. Brunson (primary and tertiary goals), and LMJL-Alea, co-owned by Dr. Stamm (secondary goal).
...
All project packages will be licensed compatibly with R[^r-licenses] and Tidyverse (MIT, GPL >= 2).

[^r-licenses]: <https://www.r-project.org/Licenses/>

The PIs will provide the R Consortium with monthly progress reports based on the expected dates of deliverables below.
